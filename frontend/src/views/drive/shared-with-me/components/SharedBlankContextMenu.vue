<template>
  <Teleport to="body">
    <div
      v-if="visible"
      class="shared-blank-menu"
      :style="{ left: `${x}px`, top: `${y}px` }"
      @click.stop
      @contextmenu.prevent.stop
    >
      <button type="button" @click="$emit('pin')">
      ...
      <hr />
      <button type="button" @click="$emit('select-all')">
...
import { Close, FolderAdd, Grid, Operation, Refresh } from '@element-plus/icons-vue';
